/**
 *@writer Shubam Singh Manhas
 * @date of creation 24/03/2018
 */
import java.awt.*;
 ...
 */
   public class Nothing {        
    ...
    /**
     * Constructor of the Nothing Class
     */
    public Nothing(){
        newGui();
    }
    ...
    /**
     * Method to make GUI for the program
     *
     */
    public void newGui(){

        delFrame = new Frame("1st Assignment");
        delFrame.setBackground(Color.white);
        delFrame.setSize(900,600);
        delFrame.setLayout(new GridLayout(8,1));

/**
 * This is used to close the window when user clicks cross
 */
        ...
        delFrame.add(topLabel);
        delFrame.add(panel1);
        delFrame.add(bottomLabel1);
        delFrame.add(bottomlabel2);
        delFrame.add(message);
        delFrame.add(errorMessage);
        delFrame.add(panel2);


        delFrame.setVisible(true);
        topLabel.setText("Click BROWSE button to select a file. Click SPLITTED FILES button to view files.");  
  }
        ...
        // getting extension of selected file
                ...
                if (i > 0) {
                    extension = fileName.substring(i+1);// To get part of string substring() is used. 
                                                        // Here (i+1) is the begining index of the substring.
                }
                return extension;
    ...
    private void action() {
        ...
        delFrame.add(button1);
        panel1.add(button1);
        Button button2 = new Button("SPLITTED FILES");
        delFrame.add(button2);
        panel2.add(button2);

        FileDialog fileDialog = new FileDialog(delFrame);
        button1.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                bottomLabel1.setText("Selected File: " + fileDialog.getFile()
                        + " , from Directory :    " + fileDialog.getDirectory() );
                bottomlabel2.setText( "Length of file: " + file.length() + "  Bytes"
  ...
  Path targetFile = Paths.get(checkOS() + "CopyOf-"+fileDialog.getFile()+"." + getExtension(fileName)); //accepts sitable path from checkOS
                                                                                                        // Function.
                    try {
    ...
    public static void main(String[] args) throws IOException   //Main Method to make the program work
       { 
        Nothing nothing = new Nothing();
        nothing.action();  // awt.checkOS();
    }
